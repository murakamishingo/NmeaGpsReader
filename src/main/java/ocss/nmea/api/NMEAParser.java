...
//        System.out.println("Receieved Data:" + e.getContent());
  ...
  /*
   * this is used to take only the last GAA parameter if the buffer contains multiple GAA lines.
   */
  public void loop()
  {
    while (true)
    {
      ...
      { 
        ...
        //XXX
        //murakamishingo: fireDataDetected call moved here to take the last s
        //if(!last.equals(""))
        	//this.fireDataDetected(new NMEAEvent(this, last));
